...
const About = () => {
  ...
  return (
    <section id="about" className="py-24 bg-web3-dark">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              {achievements.map((achievement, index) => (
                <Badge key={index} variant="secondary" className="bg-web3-card text-web3-cyan border-web3-border p-3 text-center">
                  {achievement}
                </Badge>
              ))}
            </div>
